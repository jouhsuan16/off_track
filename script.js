...
function makeDraggable(element) {
    ...
    const onMouseUp = () => {
        ...
        if (!isSplitView && centerRect) {
            ...
            // When dropped, it will eventually revert to 120x120 unless hovered, 
            // but we want to make sure the final resting 120x120 box isn't overlapping
